...
import sk.mkdigital.kmpshowcase.shared.generated.resources.storage_clear_session
import sk.mkdigital.kmpshowcase.shared.generated.resources.storage_persistent_hint
import sk.mkdigital.kmpshowcase.shared.generated.resources.storage_persistent_label
...
fun StorageScreen(
    ...
    LazyColumn(
        ...
        item {
            Column {
                TextBodyLargeNeutral80(stringResource(Res.string.storage_subtitle))
            }
        }
